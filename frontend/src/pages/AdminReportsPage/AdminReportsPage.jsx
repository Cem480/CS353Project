...
export default function AdminReportsPage() {
    ...
    if (loading) return (
        <div className="admin-main-page">
            <AdminHeader />
            <div className="admin-reports-page"><p>Loading…</p></div>
        </div>
    );
    ...
    if (error) return (
        <div className="admin-main-page">
            <AdminHeader />
            <div className="admin-reports-page error">{error}</div>
        </div>
    );
                        ...
                        {reports.map(r => {
                            ...
                            return (
                                <tr
                                    ...
                                    className="clickable"
                                    onClick={() => {
                                        sessionStorage.setItem('cameFrom', 'past');
                                        navigate(`/admin/reports/${topic}/${r.report_id}`);
                                    }}
